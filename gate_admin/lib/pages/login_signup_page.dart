          ...
          child: new ListView(
            ...
            children: <Widget>[
              ...
              new Row(
                ...
                children: <Widget>[
                  new Flexible(child: _showWingInput()),
                  new Flexible(child: _showHouseInput())
                ],
              ),
              _showPasswordInput(),
              _showPrimaryButton(),
    ...
    if (widget.flatUser) {
      return Padding(
        ...
        child: new TextFormField(
          ...
          validator: (value) => value.isEmpty ? 'Wing can\'t be empty' : null,
          onSaved: (value) => _wing = value,
        ),
      );
    } else {
      return new Container();
